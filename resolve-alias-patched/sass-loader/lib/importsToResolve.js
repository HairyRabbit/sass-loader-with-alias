...
function importsToResolve(url) {
    ...
    return [
        ...
        `${ request }.scss`, `${ request }.sass`, `${ request }.css`,
        `${ request }/_index.scss`, `${ request }/_index.sass`, `${ request }/_index.css`,
        `${ request }/index.scss`, `${ request }/index.sass`, `${ request }/index.css`,
        `${ url }/_index.scss`, `${ url }/_index.sass`, `${ url }/_index.css`,
        `${ url }/index.scss`, `${ url }/index.sass`, `${ url }/index.css`,
        `${ url }.scss`, `${ url }.sass`, `${ url }.css`,
        `${ replacedUrl }.scss`, `${ replacedUrl }.sass`, `${ replacedUrl }.css`,
        url
    ];
}
